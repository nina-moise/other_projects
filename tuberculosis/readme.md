...
Проект реализован в команде **Яндекс Мастерской**. Даты проекта: 02.04.2026-18.05.2026
...
Эти этапы предполагали командную работу, каждый член команды обрабатывал одну таблицу отчетной формы № 33 за 3 года. Я занималась предобработкой таблицы 2100 формы  №33 за 2019-2021 годы.
...
[Jupyter Notebooks](https://github.com/nina-moise/other_projects/blob/main/tuberculosis/transform_table_2100.ipynb) [HTML](https://github.com/nina-moise/other_projects/blob/main/tuberculosis/transform_table_2100.html)
 ...
 - [официальный сайта Иркутскстата](https://38.rosstat.gov.ru/) - для формирования файла со среднегодовым населением.
...
●Сокращение времени на анализ эпидситуации и работы лечебной сети – на 80% (благодаря автоматизации расчётов и визуализации).

●Повышение точности и обоснованности управленческих решений за счёт прогнозных моделей и удобного доступа к данным.
