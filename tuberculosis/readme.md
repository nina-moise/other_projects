...
**Результат:** объединенный пул таблиц за 2019-2021 годы + файл со среднегодовым населением Иркутской области в разрезе года, пола и возраста [population.csv](https://github.com/nina-moise/other_projects/blob/main/tuberculosis/population.csv)
