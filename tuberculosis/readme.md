...
**Результат:** с помощью BI-системы для визуализации и анализа данных Yandex DataLens разработан дашборд ["Сведения о заболеваемости туберкулезом по Российской Федерации и Иркутской области"](https://datalens.yandex/7ik3h5uj969ir)
